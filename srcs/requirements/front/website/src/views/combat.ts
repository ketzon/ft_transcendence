            ...
            <div class="relative inline-block">
                ...
                <!-- Player health -->
                    <div class="relative h-[30px] w-full flex justify-end">
                        <div class="bg-red-500 h-[30px] w-full"></div>
                        <div  id="playerHealth" class="absolute bg-indigo-400 top-0 right-0 bottom-0 w-full"></div>
                    </div>
                    <!-- Timer -->
                    <div id="timer" class="flex items-center justify-center text-white bg-black h-[50px] w-[100px] shrink-0">10</div>
                    <!-- Enemy health -->
                    <div class="relative h-[30px] w-full">
                        <div class="bg-red-500 h-[30px]"></div>
                        <div  id="enemyHealth" class="absolute bg-indigo-400 top-0 right-0 bottom-0 left-0"></div>
                    </div>
                </div>
