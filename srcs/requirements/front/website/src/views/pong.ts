export function pongView(bgImg: string = "bg-map-classic"): string {
    return /*html*/`
<div class="h-full w-full flex justify-center items-center flex-col">
    ...
    <!-- elements du jeu -->
      ...
      <div id="game-container" class="relative">
        <div id="game-board" class="${bgImg} bg-cover bg-center rounded relative w-[800px] h-[400px] border border-violet-400">
